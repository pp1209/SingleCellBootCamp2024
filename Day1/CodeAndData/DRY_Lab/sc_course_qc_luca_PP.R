...
sample_1 <- Read10X("SingleCellBootCamp2024-main/Day1/CodeAndData/DRY_Lab/Patient_01/raw_feature_bc_matrix/")
sample_2 <- Read10X("SingleCellBootCamp2024-main/Day1/CodeAndData/DRY_Lab/Patient_02/raw_feature_bc_matrix/")
